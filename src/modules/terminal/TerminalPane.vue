...
<template>
  ...
  >
    <div
      ref="container"
      class="nexterm-terminal-scrollbar zoom-exempt flex h-full w-full items-center justify-center rounded-sm bg-background focus-within:ring-1 focus-within:ring-terminal-focus"
    />
    <div
      v-if="contextMenu"
      ref="menuEl"
