const enUS = {
  ...
  settings: {
    ...
    general: {
      ...
      remoteCopyUrl: "Copy",
      remoteLocalhostAccess: "Local and LAN web access",
      remoteLocalhostHint:
        "Nexterm listens on this computer and your LAN. Keep the token private.",
      remotePort: "Port",
      remoteRefreshToken: "Refresh",
      remoteRunning: "Remote terminal is running for local and LAN access.",
      remoteStopped: "Remote terminal is stopped.",
      remoteTerminal: "Remote terminal",
      remoteToken: "Token",
      remoteTokenEmpty: "not generated",
      remoteUrl: "URL",
      remoteUrlUnavailable: "Enable remote terminal to generate an access URL.",
