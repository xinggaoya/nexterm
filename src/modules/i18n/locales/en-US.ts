const enUS = {
  ...
  picker: {
    ...
    loadFailed: "Cannot open this folder",
    loading: "Loading…",
    nameLabel: "Name",
    ...
    noInitialPath: "No start folder available. Enter a path above.",
    noMatches: "No matches",
    noSelection: "Nothing selected",
    pathPlaceholder: "Enter a path and press Enter",
    placesHome: "Home",
    placesRoot: "Filesystem",
    refresh: "Refresh",
    retry: "Retry",
    showHidden: "Show hidden files",
    titleDirectory: "Select Folder",
  ...
  findInFiles: {
    caseInsensitive: "Aa",
    caseInsensitiveTitle: "Match case insensitively",
    includePlaceholder: "Include: *.ts, *.tsx",
    invalidRegex: "Invalid regular expression",
    noResults: "No matches",
    prompt: "Type characters to search workspace content.",
    regexTitle: "Regular expression mode",
    searchPlaceholder: "Find in workspace",
  ...
  sourceControl: {
    ...
    tagCreateDetail: "Created tag {name}",
    tagCreateFailed: "Failed to create tag",
    tagCreateSuccess: "Tag created",
    tagNamePlaceholder: "Tag name, e.g. v1.0.0",
    tagNameInvalid: "Tag name cannot start with '-' or contain spaces",
    tagMessagePlaceholder: "Annotation message (optional)",
    tagMessageHint: "Leave empty for a lightweight tag; fill in for an annotated tag.",
    tagSearch: "Search tags…",
    tagSearchEmpty: "No matching tags",
    tagsEmpty: "No tags yet",
    tagAnnotated: "annotated",
    tagPush: "Push tag",
    tagPushedTo: "Pushed {target}",
    tagPushFailed: "Failed to push tag",
    tagPushSuccess: "Tag pushed",
    tagDelete: "Delete",
    tagDeleteTitle: "Delete tag?",
    tagDeleteConfirmContent: "This permanently deletes the local tag \"{name}\".",
    tagDeleteDetail: "Deleted tag {name}",
